...
export default function Login() {
  ...
  // Rediriger si déjà connecté (seulement après l'initialisation)
  useEffect(() => {
  ...
  // Afficher un loader si l'auth n'est pas encore initialisé
  if (authLoading) {
          ...
          <CardContent className="space-y-6">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <Link to="/forgot-password" className="text-sm text-primary hover:text-primary-dark underline">
                  Mot de passe oublié ?
                </Link>
              </div>

              <Button type="submit" className="w-full bg-gradient-to-r from-primary to-primary-dark hover:shadow-lg" disabled={isLoading}>
