...
class StoreSortieConteneurRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'vehicule_camion_id' => 'required|exists:vehicules,id',
            'vehicule_remorque_id' => 'required|exists:vehicules,id',
    ...
    public function messages()
    {
        return [
            ...
            'vehicule_camion_id.required' => 'Le camion est obligatoire',
            'vehicule_camion_id.exists' => 'Le camion sélectionné n\'existe pas',
            'vehicule_remorque_id.required' => 'La remorque est obligatoire',
            'vehicule_remorque_id.exists' => 'La remorque sélectionnée n\'existe pas',
